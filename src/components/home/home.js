  ...
  render() {
    ...
    return (
      <div style={{height:'100vh',width:'100%',display:'flex',alignItems:'center',justifyContent:'center',position:'static'}}>
        ...
        <div style={{width:'48.5vw', height:'100%', display:'flex',flexDirection:'column', justifyContent:"center",alignItems:'center',textDecoration:'none'}}>
        ...
        <div style={{width:'48.5vw', height:'100%', display:'flex',flexDirection:'column',justifyContent:"center",alignItems:'center',textDecoration:'none'}}>
          <h1>TESTAR MODELO</h1>
          <div style={{textDecoration:'none',textTransform:'none',cursor:'pointer',display:'flex',justifyContent:"center",alignItems:'center',width:'320px',height:'320px',borderRadius:'100%',border:'3px solid black',fontSize:'80px'}}><Icon style={{textDecoration:'none',textTransform:'none',color:'black'}}type="audio" /></div>
        </div>
        </Link>
      </div>
    );
